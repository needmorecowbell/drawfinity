...
1. **Read the gaps list** from `/home/adam/Dev/drawfinity/Auto Run Docs/LOOP_00001_GAPS.md`
2. **Rate each gap** for user importance and fix effort
3. **Assign status** based on ratings
4. **Output prioritized plan** to `/home/adam/Dev/drawfinity/Auto Run Docs/LOOP_00001_PLAN.md`

## Evaluation Checklist

- [x] **Evaluate gaps (or skip if empty)**: Read `/home/adam/Dev/drawfinity/Auto Run Docs/LOOP_00001_GAPS.md`. If it contains no gaps OR all gaps have already been evaluated in `LOOP_00001_PLAN.md`, mark this task complete without changes. Otherwise, rate each gap by USER IMPORTANCE (CRITICAL/HIGH/MEDIUM/LOW) and FIX EFFORT (EASY/MEDIUM/HARD). Mark gaps with HIGH/CRITICAL importance and EASY/MEDIUM effort as PENDING for auto-fix. Output to `/home/adam/Dev/drawfinity/Auto Run Docs/LOOP_00001_PLAN.md`.
  - **Note:** Existing `LOOP_00001_PLAN.md` contained code-level documentation gaps from a different pipeline. README gap evaluation written to `LOOP_00001_README_PLAN.md` to avoid overwriting. Evaluated all 24 gaps: 16 PENDING for auto-fix, 1 needs review, 7 won't do.
...
Create/update `/home/adam/Dev/drawfinity/Auto Run Docs/LOOP_00001_PLAN.md` with:
...
1. You've read `/home/adam/Dev/drawfinity/Auto Run Docs/LOOP_00001_GAPS.md`
2. You've evaluated gaps with importance and effort ratings
3. You've output the prioritized plan to `/home/adam/Dev/drawfinity/Auto Run Docs/LOOP_00001_PLAN.md`
