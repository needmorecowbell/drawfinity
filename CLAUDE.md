...
### Test environment
Tests use **Vitest** with **jsdom** for DOM-dependent tests. WebGL is mocked in renderer tests. Run the full suite with `npx vitest run` — all 662 tests should pass in ~5s.
